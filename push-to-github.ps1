...
$configFile = Join-Path $PSScriptRoot "github-config-new.json"
...
Write-Host "Done! Changes have been pushed to GitHub." -ForegroundColor Green# PowerShell script to push changes to GitHub
# Usage: .\push-to-github.ps1 "Your commit message here"
